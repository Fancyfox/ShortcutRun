...
import Obj from "./Obj";
import ES from "../script/Singleton/ES";
...
export default class Obs extends Obj {
    ...
    onStart(){
        ES.instance.on(ES.on_game_reset,this,this.onGameReset);
        ES.instance.on(ES.on_pass_level,this,this.onFinal);
    }    
    ...
    // onPlayerLoaded(index: number) {
    //     if (GameManager.instance.singlePlayer) {
    //         this.ready = true;
    //         this.playerPos1 = GameManager.instance.player1.transform.position;
    //         this.playerPos = GameManager.instance.player1.transform.position;
    //     }
    //     else {
    //         let p1 = GameManager.instance.player1;
    //         let p2 = GameManager.instance.player2;
    //         if (p1 && p2) {
    //             this.ready = true;
    //             this.playerPos1 = p1.transform.position;
    //             if (Mathf.Abs(this.transform.position.x - p1.transform.position.x) < 10) this.playerPos = p1.transform.position;
    //             else this.playerPos = p2.transform.position;
    //         }
    //     }
    // }
