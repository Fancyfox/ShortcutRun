...
export default class CannonManager {
    ...
    public GetTouchPos3D(camera:Laya.Camera,drawPlane:Laya.Sprite3D,pos:Laya.Vector3):Laya.Vector3
    {
     ...
     //  var lineSprite:Laya.PixelLineSprite3D = GameManager.instance.scene.addChild(new Laya.PixelLineSprite3D(1)) as Laya.PixelLineSprite3D;
    //  lineSprite.addLine(this.touchRay.origin, this.touchRay.direction, Laya.Color.RED, Laya.Color.GREEN);
    ...
    clear(index?: number) {
        if (index === 0) {
            this.que = [];
            this.world = null;
            // Laya.timer.clear(this, this.updateCannonWorld);
